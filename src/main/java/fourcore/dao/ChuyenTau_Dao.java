...
public class ChuyenTau_Dao {
	...
	public ChuyenTau chuyen1 = new ChuyenTau(10000, LocalDateTime.of(2025, 10, 3, 15, 30),
			LocalDateTime.of(2025, 10, 14, 3, 30), tau1, "CT001");
	public ChuyenTau chuyen2 = new ChuyenTau(10000, LocalDateTime.of(2025, 10, 3, 20, 30),
			LocalDateTime.of(2025, 7, 14, 12, 30), tau2, "CT002");
	public ChuyenTau chuyen3 = new ChuyenTau(10000, LocalDateTime.of(2025, 10, 1, 7, 00),
			LocalDateTime.of(2025, 9, 14, 4, 30), tau3, "CT003");
	public ChuyenTau chuyen4 = new ChuyenTau(10000, LocalDateTime.of(2025, 10, 2, 12, 00),
			LocalDateTime.of(2025, 4, 14, 5, 30), tau2, "CT004");
	public ChuyenTau chuyen5 = new ChuyenTau(10000, LocalDateTime.of(2025, 10, 2, 12, 00),
			LocalDateTime.of(2025, 4, 14, 5, 30), tau2, "CT005");
	public ChuyenTau chuyen6 = new ChuyenTau(10000, LocalDateTime.of(2025, 10, 2, 12, 00),
			LocalDateTime.of(2025, 4, 14, 5, 30), tau2, "CT006");
