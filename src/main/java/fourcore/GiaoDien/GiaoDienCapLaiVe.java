...
//        VBox pnlsubCT2 = taoSubCT2("Giá vé", nf.format(ve1.getGiaVe()), lblCTStyle, lblValueCTStyle);
		...
		VBox pnlsubCT5 = taoSubCT2("Thành tiền", String.valueOf(giave), lblCTStyle, lblValueCTStyle);
					...
					try {
						...
						if (pdfFile.exists()) {
							if (Desktop.isDesktopSupported()) {
								...
								System.out.println("Desktop không được hỗ trợ. Vui lòng mở file thủ công: "
