...
import fourcore.Control.DoiVeControl;
...
public class GioVeDoiVe extends Application {
    ...
    private Label lblTrangThaiApDung = new Label();
    ...
    public GioVeDoiVe() throws SQLException {
    }
...
//	          USER BOX
            ...
            try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("gheDoi.dat"))) {
                GheTrenChuyenTau gheSelected = (GheTrenChuyenTau) ois.readObject();
                listGheSelected.add(gheSelected);
            ...
            btnTiepTuc.setOnMouseClicked(event -> {
                ...
                if(mapChuyenTauVaUser.size()==tongGheTrenChuyenTau.size()) {
                    ...
                    if (doiVeControl != null) {
                        try {
                            BorderPane root2 = (BorderPane) ((Node) event.getSource()).getScene().getRoot();
                            doiVeControl.tiepDenGDXuatHoaDon(root2, noiDungChinh);
...
//			primaryStage.show();
    ...
    public VBox taoDataChoTableGioVe(GheTrenChuyenTau gheTrenChuyenTau, String flag) throws SQLException {
        ...
        Label[] labels = null;
        if(flag.equals("di")){
            labels = new Label[]{new Label(gheTrenChuyenTau.getChuyenTau().getMaChuyenTau()), new Label(vechon.getGaDi() +" - " + vechon.getGaDen()),
...
//	-fx-padding: 8 12 8 12;
        ...
        pnlsubCT1.addRow(0, taoSubCT1("Họ tên", vechon.getKhachHang().getHoten(), leftStyle, rightStyle, 1));
        pnlsubCT1.addRow(1, taoSubCT1("Đối tượng", vechon.getDoiTuongGiamGia().getTenDoiTuongGiamGia(), leftStyle, rightStyle, 2, giaTienGhe,
                lblGiamDoiTuongValue, lblThanhTienValue, gheTrenChuyenTau));
        pnlsubCT1.addRow(2, taoSubCT1("Số giấy tờ", vechon.getKhachHang().getCccd(), leftStyle, rightStyle, 3));
    ...
    private HBox taoSubCT1(String label, String value, String leftStyle, String rightStyle, int check) {
        ...
        if (check == 1) {
            ...
            txtSoGiayTo.setText(value);
            txtSoGiayTo.setStyle(rightStyle);
            txtSoGiayTo.setEditable(false);
    ...
    private HBox taoSubCT1(String label, String value, String leftStyle, String rightStyle, int check,
        ...
        if (check == 2) {
            ...
            cmbDoiTuong.setValue(value);
                String tenDoiTuong = value;
                ...
                tongCongThanhTien = thanhTienMoi;
