...
//			primaryStage.show();
	...
	public void create_title_layout() {
		...
		lbl_title = new Label("Thống kê Doanh Thu Theo Năm"); 
...
//        		noiDungChinh.getChildren().remove(layout_total);
	...
	public void create_barchart_chuyentau()
	{
			...
			listdata.add(new XYChart.Data<>("CT001", 10));
			listdata.add(new XYChart.Data<>("CT002", 20));
			listdata.add(new XYChart.Data<String, Number>("CT003", 30));
			listdata.add(new XYChart.Data<String, Number>("CT004", 40));
			listdata.add(new XYChart.Data<String, Number>("CT005", 50));
			listdata.add(new XYChart.Data<String, Number>("CT006", 60));
			listdata.add(new XYChart.Data<String, Number>("CT007", 70));
			listdata.add(new XYChart.Data<String, Number>("CT008", 80));
			listdata.add(new XYChart.Data<String, Number>("CT009", 90));
			listdata.add(new XYChart.Data<String, Number>("CT010", 100));
