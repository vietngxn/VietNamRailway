...
//			showMenuPhuIcon = new Image(clazz.getResourceAsStream("/resources/images/chevron-up.png"));
	...
	public void create_table_layout() {
		...
		lbl_title_maHoaDon.setStyle(style);
		
		lbl_title_nguoiMua = new Label("Người Mua");
		lbl_title_nguoiMua.setStyle(style);
		
		
		lbl_title_ngayLap = new Label("Ngày Lập");
		lbl_title_ngayLap.setTranslateX(10);
		lbl_title_ngayLap.setStyle(style);
		
		lbl_title_loaiHoaDon = new Label("Loại Hóa Đơn");
		lbl_title_loaiHoaDon.setTranslateX(60);
		lbl_title_loaiHoaDon.setStyle(style);
		
		
		
		
		lbl_title_tongTien = new Label("Tổng Tiền");
		lbl_title_tongTien.setTranslateX(300);
		lbl_title_tongTien.setStyle(style);
		
		

		table_title.getChildren().addAll(lbl_title_maHoaDon,lbl_title_nguoiMua,lbl_title_ngayLap,lbl_title_loaiHoaDon,lbl_title_tongTien);
	...
	public void create_layout_button()
	{
		...
		btn_xuatHoaDon.hoverProperty().addListener((obs,oval,nval) -> {
			if(nval)
			{
				btn_xuatHoaDon.setStyle(btn_xuatHoaDon.getStyle() +"-fx-cursor:hand;");
			}
			else {
				btn_xuatHoaDon.setStyle(btn_xuatHoaDon.getStyle());
			}
		});
	...
	public void create_layout_dong(String mahoadon,String nguoimua,LocalDate ngaylap,String loaiHD,double tongtien)
	{
		...
		Label maHoaDon = new Label(mahoadon);
	
		maHoaDon.setStyle(style);
	
		
		Label nguoiMua = new Label(nguoimua);
		nguoiMua.setTranslateX(45);
		nguoiMua.setStyle(style);
		nguoiMua.setWrapText(true);
		
	
		DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd/MM/yyyy");
		String ngaylap1 = ngaylap.format(dtf);
		Label ngayLap = new Label(ngaylap1);
		ngayLap.setTranslateX(60);
		ngayLap.setStyle(style);
	
		
		
		Label loaiHoaDon = new Label(loaiHD);
		loaiHoaDon.setTranslateX(120);
		loaiHoaDon.setStyle(style);
		
		
		
		Label tongTien = new Label(""+tongtien);
		tongTien.setTranslateX(380);
		tongTien.setStyle(style);
		...
		layout_dong.getChildren().addAll(maHoaDon,nguoiMua,ngayLap,loaiHoaDon,tongTien);
